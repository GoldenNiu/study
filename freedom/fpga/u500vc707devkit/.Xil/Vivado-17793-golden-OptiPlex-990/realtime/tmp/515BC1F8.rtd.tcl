...
set genomeRtd $env(RT_TMP)/515BC1F8.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is mig_7series_v4_0_memc_ui_top_axi__GC0"
puts "this genome's rtd file is $genomeRtd"
source $::env(HRT_TCL_PATH)/rtSynthPrep.tcl
source $::env(RT_TMP)/parameters.tcl
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList ./.Xil/Vivado-17793-golden-OptiPlex-990/realtime/tmp/parallel_timing.xdc; 
set genomeName mig_7series_v4_0_memc_ui_top_axi__GC0
