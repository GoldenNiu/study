...
set genomeRtd $env(RT_TMP)/36ECFE18.rtd
...
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList ./.Xil/Vivado-7045-golden-OptiPlex-990/realtime/tmp/parallel_timing.xdc; 
