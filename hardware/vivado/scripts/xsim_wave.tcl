...
add_wave_divider AXIS_VF
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_wr_tlast
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_wr_tdata
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_wr_tvalid
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_wr_tkeep
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_wr_tready
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_wr_aclk
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_rd_tlast
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_rd_tdata
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_rd_tvalid
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_rd_tkeep
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_rd_tready
add_wave -radix hex /board/dut/mp_pfifo_inst/axi_str_rd_aclk
